...
export default function OnboardingSuccess() {
  return (
    <div className="onboarding-success-page">
      ...
      <main className="onboarding-success-content" role="main" aria-labelledby="success-title">
        ...
        <p className="success-subtitle">
          Your merchant account is ready. Create a pricing plan or explore the dashboard to start accepting subscriptions.
        </p>
