...
import { Activity, ChevronRight, Menu, Pause, XCircle } from "lucide-react";
    ...
    return (
      <>
        <button
          ...
          className="w-full max-w-md mx-auto bg-[#000000] rounded-2xl p-4 border border-[#191919] flex items-center gap-3 transition-colors focus:outline-none focus:ring-2 focus:ring-white/30"
          aria-label="Open subscription actions"
          aria-haspopup="dialog"
          aria-expanded={sheetOpen}
        >
          <div className="bg-[#191919] p-1 rounded-md">
            <Menu className="w-5 h-5 text-[#90A1B9]" strokeWidth={2} />
          </div>
          <h2 className="text-white font-bold text-lg flex-1 text-left">Actions</h2>
          <ChevronRight className="w-5 h-5 text-gray-400" strokeWidth={2} />
        </button>
        <BottomSheet
          isOpen={sheetOpen}
